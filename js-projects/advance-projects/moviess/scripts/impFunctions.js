...
export function makeCard(data){
    ...
    <img src="${imgUrl}/${data.poster_path || data.profile_path }" alt="img">
...
export function makeExpandCard(data, cardMain, genres, infoIntro, casts){
    ...
    <div class="video">
        <iframe src="https://www.youtube.com/embed/${data.videos.results[0].key}" frame-border="0" width="100%" height="100%"></iframe>
        <button class="btn cross">x</button>
    </div>
    
    `;
    cardMain.style.backgroundImage = `url("${bckdrpUrl}/${data.backdrop_path}")`;
    ...
    <div class="info">
        ...
        <p>Duration : <span>${data.runtime}min</span></p>
